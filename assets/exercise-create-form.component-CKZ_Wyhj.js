import{i as e,r as t}from"./health-g_cdKYy9.js";import{t as n}from"./css-Dp6z7v3R.js";var r=n(`:host{display:block}.ex-form{background:var(--sec-card,#1e1e1e);color:var(--sec-ink);border:1px solid var(--sec-line,#444);border-radius:.75rem;flex-direction:column;gap:.6rem;padding:.85rem;display:flex}.ex-form__field{flex-direction:column;flex:1;gap:.25rem;display:flex}.ex-form__field>span{opacity:.7;font-size:.8rem}.ex-form__row{gap:.6rem;display:flex}.ex-form__input{background:var(--sec-control);color:var(--sec-ink);border:1px solid var(--sec-line,#555);box-sizing:border-box;border-radius:.5rem;padding:.5rem;font-size:.95rem}.ex-form__tracks{border:1px solid var(--sec-line,#444);border-radius:.5rem;gap:1rem;margin:0;padding:.4rem .6rem;font-size:.85rem;display:flex}.ex-form__tracks legend{opacity:.6;padding:0 .3rem;font-size:.75rem}.ex-form__tracks label{align-items:center;gap:.3rem;display:inline-flex}.ex-form__error{color:#f87171;margin:0;font-size:.85rem}.ex-form__actions{justify-content:flex-end;gap:.6rem;display:flex}.ex-form__btn{border:1px solid var(--sec-line,#555);background:var(--sec-control);color:var(--sec-ink);cursor:pointer;border-radius:.5rem;padding:.5rem 1rem;font-size:.9rem}.ex-form__btn--primary{color:#fff;background:#2563eb;border-color:#2563eb}`);function i(e){return e.trim().toLowerCase().replace(/[^a-z0-9]+/g,`_`).replace(/^_+|_+$/g,``)}var a=document.createElement(`template`);a.innerHTML=`
...
//# sourceMappingURL=exercise-create-form.component-CKZ_Wyhj.js.map