...
`;var x=class extends HTMLElement{initialized=!1;detail=null;loadSequence=0;dateValue=``;dialogHost=null;set date(e){this.dateValue=e}connectedCallback(){if(!this.initialized){this.initialized=!0;let e=r(this,`Health`,`health`,`/health`);this.detail=document.createElement(`health-day-detail`),this.detail.dateContext=this.dateValue,this.detail.showLoading(),e.content.appendChild(this.detail),this.dialogHost=document.createElement(`div`),e.content.appendChild(this.dialogHost),this.dialogHost.appendChild(b.content.cloneNode(!0)),this.wireDetail(),this.wireAddDialog()}this.detail&&(this.detail.dateContext=this.dateValue),this.loadData()}wireDetail(){this.detail&&(this.detail.addEventListener(d.ADD_WORKOUT,e=>{this.openManualAddDialog(e.detail.date)}),this.detail.addEventListener(d.ADD_FOOD,t=>{e(`/health/food-entry/${encodeURIComponent(t.detail.date)}/${encodeURIComponent(t.detail.meal)}`)}),this.detail.addEventListener(d.EDIT_FOOD,t=>{e(`/health/nutrition/${encodeURIComponent(t.detail.entry.id)}`)}),this.detail.addEventListener(d.EDIT_WORKOUT,t=>{e(`/health/activity/${encodeURIComponent(t.detail.activity.id)}`)}))}wireAddDialog(){let e=this.querySelector(`#activity-dialog`),t=this.querySelector(`#activity-form`);!e||!t||e.addEventListener(`close`,()=>{if(e.returnValue!==`save`){t.reset();return}let n=this.querySelector(`#act-title`)?.value??``,r=this.querySelector(`#act-type`)?.value??`other`,i=this.querySelector(`#act-date`)?.value??``,a=this.querySelector(`#act-duration`)?.value??``,o=a?parseInt(a,10):void 0;if(!n||!i){t.reset();return}this.saveManualActivity({title:n,type:r,date:i,duration_minutes:o}),t.reset()})}async saveManualActivity(e){try{await a.createActivity(e),await this.loadData()}catch(e){console.error(`Failed to create activity`,e),this.detail?.showError(`Failed to save activity.`)}}openManualAddDialog(e){let t=this.querySelector(`#activity-dialog`),n=this.querySelector(`#act-date`);!t||!n||(n.value=e,t.showModal())}async loadData(){if(!this.detail)return;let e=++this.loadSequence;this.detail.dateContext=this.dateValue,this.detail.showLoading();try{let[t,n]=await Promise.all([a.fetchActivitiesByDate(this.dateValue),a.fetchNutritionByDate(this.dateValue)]);if(e!==this.loadSequence||!this.detail)return;this.detail.activities=t,this.detail.nutrition=n,this.detail.hideLoading(),this.detail.showContent()}catch(t){console.error(`Failed to load day detail data`,t),e===this.loadSequence&&this.detail.showError(`Failed to load detail for ${this.dateValue}`)}}};customElements.define(`health-day-screen`,x);export{x as HealthDayScreen};
//# sourceMappingURL=health-day-screen.component-N-64RHW9.js.map